...
- [x] Merge Java `ProviderHeaderContributor` headers before OpenAI/Anthropic non-streaming provider calls, with explicit request headers taking precedence
