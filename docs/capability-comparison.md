...
- Copilot auth/device-code polling behavior and split-turn compaction summary serialization.
- OpenAI Codex WebSocket connection rotation and DS4 context-overflow detection.
