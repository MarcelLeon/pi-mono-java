...
- Provider-native multimodal attachment parts beyond the current OpenAI and Anthropic non-streaming image paths; Bedrock, documents, and streaming requests still carry CLI `@file` attachments as structured text.
