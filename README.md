...
- [x] Merge Java `ProviderHeaderContributor` headers before OpenAI/Anthropic/Bedrock non-streaming provider calls, with explicit request headers taking precedence and provider-managed auth/signing headers protected
